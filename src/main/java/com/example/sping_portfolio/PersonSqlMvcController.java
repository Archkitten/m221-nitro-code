...
public class PersonSqlMvcController implements WebMvcConfigurer {
    ...
    */
    ...
    @PostMapping("/sql/addtask")
    public void addTask(@Valid Person person, JSONObject task, long unixDate) {
        person.addTask(task, unixDate);
    }
    ...
    */
    ...
    public ResponseEntity<String> postPerson(@RequestParam("email") String email,
                                             @RequestParam("points") String password) {
        /*
        Date dob;
        try {
